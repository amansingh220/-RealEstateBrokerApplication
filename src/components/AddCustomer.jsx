...
// AddBroker functional component is used to take to data from the customer at the time of registration.
function AddCustomer({ insertCustomer, ...props }) {
  ...
  // Below implemented function is used to call insertCustomer function to dispatch an action.
  useEffect(() => {
  ...
  // Handles the event fired when customer presses register button.
...
// Exporting the AddCustomer component after connecting it to the redux-store using connect function from react-redux.
