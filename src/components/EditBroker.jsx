          ...
          <div class="row">
            <div class="col-md-4 border-right">
              <div class="d-flex flex-column align-items-center text-center p-4 mt-1 py-1 imgwrapper">
                <img class="img-fluid" src={profile} width="242" height="100" />
              </div>
            </div>
            <div class="col-md-8">
              <div class="py-4">
...
export default connect(mapStateToProps, mapDispatchToProps)(EditBroker);
