...
// Below component has been implemented to show properties of an logged in customer.
function CustomerProperties() {

  // Getting details of a logged in customer from sessionStorage.
      ...
      <div className="py-4 mt-5">
        <div className="row">
          <table className="table table-striped table-bordered table-hover">
            ...
            <tbody>
              {loggedCustomer.properties.map((property) => (
...
// Exporting CustomerProperties component.
