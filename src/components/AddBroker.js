                  ...
                  <div className = 'col-md-7 register-right'>
                    ...
                    <form onSubmit={handleSubmit} className = 'register-form' autoComplete="on">
                        <div className = 'form-group'>
                               <input  id = 'broName' onChange={(e) => setBroker({ ...broker, broName: e.target.value })} type = 'text' className = 'form-control' placeholder = "Name" ></input>
                               <p className='text-left text-danger ml-1 error'>{broNameError}</p>
                           </div> 
                           <div className = 'form-group'>
