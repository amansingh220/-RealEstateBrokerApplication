...
{
    let brokerDetails = {broName : "", password: "", mobile : "", email : "", city : ""}
    ...
    useEffect(() => {
      const checkBox = document.getElementById("confirm");
        ...
        if(broNameError === "" && passwordError === "" && mobileError === "" && emailError === "" && cityError === "" && checkBox.checked)
        {
            insertBroker(broker)
            props.history.push({
                          ...
                          <div className = 'col-md-7 register-right'>
                            ...
                            <form onSubmit={handleSubmit} className = 'register-form' autoComplete="on">
                                <div className = 'form-group'>
                                       <input id = 'broName' required='true'  onChange={(e) => setBroker({ ...broker, broName: e.target.value })} type = 'text' className = 'form-control' placeholder = "Broker Name"></input>
                                      { <p className='text-left text-danger ml-1'>{broNameError}</p>}
                                   </div> 
                                   <div className = 'form-group'>
                                       <input id = 'email' required='true' onChange={(e) => setBroker({ ...broker, email: e.target.value })} type = 'text' className = 'form-control' placeholder = "Email"></input>
                                       <p className='text-left text-danger ml-1'>{emailError}</p>
                                   </div>
                                   <div className = 'form-group'>
                                       <input id = 'mobile' required='true' onChange={(e) => setBroker({ ...broker, mobile: e.target.value })} type = 'text' className = 'form-control' placeholder = "Mobile Number"></input>
                                       <p className='text-left text-danger ml-1'>{mobileError}</p>
                                   </div>
                                   <div className = 'form-group'>
                                       <input id = 'password' required='true' onChange={(e) => setBroker({ ...broker, password: e.target.value })} type = 'text' className = 'form-control' placeholder = "Password"></input>
                                       <p className='text-left text-danger ml-1'>{passwordError}</p>
                                   </div>
                                   <div className = 'form-group'>
                                       <input id = 'city' required='true' onChange={(e) => setBroker({ ...broker, city: e.target.value })} type = 'text' className = 'form-control' placeholder = "City"></input>
